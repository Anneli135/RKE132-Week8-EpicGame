...
string folderPath = @"C:\Users\User\OneDrive\Documents\data";
...
Console.WriteLine($"Today {villain} ({villainHP} HP) with {villainWeapon} tries to take over the wold!");
...
static int Hit(string characterName, int characterHP)
{
    ...
    {
        Console.WriteLine($"{characterName} made a circical hit!");
    }
    else
    {
